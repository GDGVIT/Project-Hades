...
import (
	...
	http "github.com/GDGVIT/Project-Hades/participants/pkg/http"
...
var fs = flag.NewFlagSet("participants", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "participants")
