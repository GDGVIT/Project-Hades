...
func makeCreateOrgHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/create-org", http1.NewServer(endpoints.CreateOrgEndpoint, decodeCreateOrgRequest, encodeCreateOrgResponse, options...))
}
...
func makeInviteHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/invite", http1.NewServer(endpoints.InviteEndpoint, decodeInviteRequest, encodeInviteResponse, options...))
}
...
func makeShowInvitesHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/show-invites", http1.NewServer(endpoints.ShowInvitesEndpoint, decodeShowInvitesRequest, encodeShowInvitesResponse, options...))
}
...
func makeShowProfileHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/show-profile", http1.NewServer(endpoints.ShowProfileEndpoint, decodeShowProfileRequest, encodeShowProfileResponse, options...))
}
